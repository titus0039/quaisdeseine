...
const loadLegend = (mymap) => {
	...
	var legend = L.control({position: 'bottomright'});
		...
		categories = ['Itinéraire de la sortie "Quais de Seine" du 08/03/2021.', 'Plus hautes eaux connues (PHEC) de l\'atlas des zones inondées (AZI).', 'Secteurs de risques du PPRI mentionnés dans le PLU de Paris et dans les PSMV du Marais et du 7<sup>ème</sup> arr.'],
